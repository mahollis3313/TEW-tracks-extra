...
if hemi == 1:
    trackfile = f'/data2/TRACK/TRACKOutput/MERRA2/{level}hPa/{year}/MERRA_CVOR{level}_T63FILT/ff_trs_pos.new.nc'
elif hemi == 2:
    trackfile = f'/data2/TRACK/TRACKOutput/MERRA2/{level}hPa/{year}/MERRA_CVOR{level}_T63FILT_SH/ff_trs_pos.new.nc'
else:
...
outfile = f'/data2/TRACK/TRACKOutput/MERRA2/FilteredTracksUpdated/{level}hPa/post_filter.{year}.{hemishort}.nc'
