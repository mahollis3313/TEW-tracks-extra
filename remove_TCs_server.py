...
trackfile = f'/data2/TRACK/TRACKOutput/MERRA2/FilteredTracksUpdated/{level}hPa/post_filter.{year}.{hemishort}.nc'
...
# Then IBTrACS
IBTrACSfile = '/data2/Data_Processed/IBTRACS/IBTrACS.since1980.v04r01.nc'
...
maskfile = f'/data2/TRACK/TRACKOutput/MERRA2/FilteredNoTCUpdated/{level}hPa/post_filter.{year}.{hemishort}.NoTC.nc'
...
masktracks.comment = f'Filtered tracks for {year}, with TCs removed. Filtered with version 6, TCs removed with v2'
